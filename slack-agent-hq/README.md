...
<h1 align="center">slack-agent-hq</h1>
...
<p align="center">
  ...
  <a href="https://github.com/splitintech/open-internal-tools/tree/main/slack-agent-hq"><img src="https://img.shields.io/badge/product-open--internal--tools-orange" alt="Open Internal Tools"></a>
...
<p align="center">
  <a href="https://www.splitin.net/tech-stack/open-internal-tools/slack-agent-hq">www.splitin.net/tech-stack/open-internal-tools/slack-agent-hq</a>
</p>
...
This folder is a standalone product in [open-internal-tools](https://github.com/splitintech/open-internal-tools). Clone the program repo, `cd` **here**, and install. It does not depend on SplitIn or on `mac-unlock-notify`. Built internally, open sourced as a package others can run. A specialist owns it end to end.
...
git sparse-checkout set slack-agent-hq
cd slack-agent-hq
```
